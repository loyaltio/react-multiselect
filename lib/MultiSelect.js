  ...
  function MultiSelect(props) {
    ...
    _this.generateLiElement = function (node, label, text, selectedValue, searchText) {
      ...
      if (node.children && node.children.length > 0) {
        ...
        if (lis.length > 0) {
          element = _react2.default.createElement(
            ...
            _react2.default.createElement(
              "div",
              null,
              _react2.default.createElement("input", { type: "checkbox", key: node[label], id: node[label], checked: optionChecked,
                "data-key": node[label],
        ...
        element = _react2.default.createElement(
          "li",
          null,
          _react2.default.createElement("input", { type: "checkbox", key: node[label], id: node[label], checked: _optionChecked,
            "data-key": node[label],
            onChange: that.onChangeOption }),
          _react2.default.createElement(
            "label",
    ...
    _this.getShowLabelText = function () {
      ...
      if (allChecked) {
        ...
        labelText = selectedValue.length + " Selected";
      } else if (showNumber && selectedValue.length > 0 && selectedValue.length <= showNumber) {
        var label = dataSourceConfig.label,
            text = dataSourceConfig.text;
